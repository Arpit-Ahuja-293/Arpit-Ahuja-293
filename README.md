...
CS & Statistics student at **Purdue University** (class of 2030) building at the intersection of AI research and shipped products. LLM researcher at **UC Berkeley** with a paper accepted to **ICLR 2026**, founding engineer at **Luminerra** (NVIDIA Inception partner, $10k+ funded), and a research intern at **Penn State** working on exoskeleton gait training for stroke patients.

```bash
$ cat .profile

ROLE        =  CS & Statistics Student, Founding Engineer, Researcher
SCHOOL      =  Purdue University (Class of 2030)
RESEARCH    =  LLM Eval @ UC Berkeley -- paper accepted ICLR 2026
STARTUP     =  Luminerra -- NVIDIA Inception Partner, $10k+ funded
ROBOTICS    =  Penn State Exoskeleton Lab | VEX World Champs (Think Award)
SIDE_BUILD  =  Jarvis | Twinly | VEX Echo Library | Ecoquest
CONTENT     =  YouTube @ArpitAhujaCodes
LOCATION    =  West Lafayette, IN
OPEN_TO     =  AI/ML Research + Full-Stack Internships
```
...
| **Full-Stack Dev** | REST APIs, real-time applications, database optimization |
| **Robotics** | Motion control, sensor-based localization, gait data analysis |
| **Research** | Academic writing, statistical analysis, data visualization |
...
<details open>
<summary><b>&#9654; Jarvis &mdash; Voice-Controlled AI Daemon</b></summary>

<br/>

Wake-word activated Python daemon with Groq-powered (Llama 3.3 70B) intent routing.

| Aspect | Detail |
| :-- | :-- |
| **Stack** | Python &middot; Vosk STT &middot; ElevenLabs TTS &middot; Tkinter |
| **Capability** | Launches apps, drafts Gmail, sends Discord messages |
| **UI** | Live Matrix-style dashboard |
| **Repo** | [`github.com/Arpit-Ahuja-293/Jarvis`](https://github.com/Arpit-Ahuja-293/Jarvis) |

</details>

<details>
<summary><b>&#9654; Twinly &mdash; AI Full-Stack Web App</b></summary>

<br/>

AI-driven web app that grew a waitlist of 2,000+ users with ML models running in production.

| Aspect | Detail |
| :-- | :-- |
| **Stack** | Python &middot; Next.js &middot; Node.js &middot; PyTorch &middot; PostgreSQL |
| **Scale** | 2,000+ waitlisted users |
| **Performance** | Optimized backend data pipelines for production ML |

</details>

<details>
<summary><b>&#9654; VEX Echo Library &mdash; Robotics Motion Library</b></summary>

<br/>

Open-sourced PID, motion profiling, and odometry algorithms for VEX robotics competition.

| Aspect | Detail |
| :-- | :-- |
| **Stack** | C++ &middot; C |
| **Impact** | Think Award winner, 2025 VEX World Championship |
| **Repo** | [`github.com/Arpit-Ahuja-293/echo-library`](https://github.com/Arpit-Ahuja-293/echo-library) |

</details>

<details>
<summary><b>&#9654; Ecoquest &mdash; Sustainability Platform</b></summary>

<br/>

Full-stack platform for community cleanup coordination and carbon tracking with a RAG chatbot.

| Aspect | Detail |
| :-- | :-- |
| **Stack** | Python &middot; FastAPI &middot; React &middot; Supabase &middot; Docker &middot; Mapbox GL |
| **Scale** | 300 users, real-time cleanup map |
| **AI** | RAG chatbot via LangChain + Gemini API |
| **Repo** | [`github.com/Arpit-Ahuja-293/ecoquest`](https://github.com/Arpit-Ahuja-293/ecoquest) |
...
**`[2025 → NOW]`** &nbsp; Co-Founding Engineer &mdash; **Luminerra**

Building AI-powered product from the ground up as a founding engineer.

- NVIDIA Inception Program partner
- $10k+ raised in funding
- Full ownership of engineering roadmap, architecture, and shipping

`AI Product` `Full-Stack` `NVIDIA Inception` `Founding Eng`

<br/>

**`[2025 → NOW]`** &nbsp; LLM Researcher &mdash; **UC Berkeley**

Research on LLM evaluation and moral reasoning frameworks.

- Co-authored paper accepted to **ICLR 2026**
- Designed evaluation methodology for large language model behavior

`LLM Evaluation` `Research` `Prompt Engineering` `ICLR 2026`

<br/>

**`[2024 → 2025]`** &nbsp; Research Intern &mdash; **Penn State**

Exoskeleton gait training research for stroke rehabilitation patients.

- Analyzed sensor-driven gait data to inform assistive control algorithms
- Applied statistical methods to clinical rehabilitation datasets

`Robotics` `Statistical Analysis` `Sensor Data` `Rehabilitation Tech`
...
| Win | Detail |
| :-- | :-- |
| &#9646; **Published Research** | Paper accepted to ICLR 2026, LLM research @ UC Berkeley |
| &#9646; **Founded & Funded** | Co-Founding Engineer @ Luminerra, NVIDIA Inception Partner, $10k+ funded |
| &#9646; **World Championship** | Think Award, 2025 VEX World Championship (open-sourced codebase) |
| &#9646; **Applied Research** | Exoskeleton gait training research @ Penn State for stroke patients |
| &#9646; **Shipped Products** | 4 projects live/open-sourced spanning AI, robotics, and sustainability |
...
```yaml
learning:
  - Agentic AI architectures & LLM evaluation frameworks
  - Advanced motion control for robotics

building:
  - Jarvis    # voice-controlled AI daemon
  - Twinly    # AI full-stack app, 2k+ waitlist

researching:
  - LLM evaluation & moral reasoning @ UC Berkeley (ICLR 2026)
  - Exoskeleton gait training @ Penn State

creating:
  - youtube: "ArpitAhujaCodes"

open_to:
  - AI/ML Research Internships
  - Full-Stack & Robotics Engineering roles
```
...
<sub><i>// by day: student & researcher &nbsp;|&nbsp; by night: shipping AI products & robotics</i></sub>
